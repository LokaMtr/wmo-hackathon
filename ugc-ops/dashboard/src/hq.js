(function(){
  ...
  function sit(a){ a.wantFace = a.facing; a.seated = true; if(a.actions) play(a, "Sitting", false, 0.35); }
  ...
  function initRobots(gltf){
    ...
    AGENTS.forEach(a=>{
      ...
      a.mixer.addEventListener("finished", e=>{ if(e.action===a.actions.Standing) return; if(a.target) play(a, a.running?"Running":"Walking"); else if(a.seated) play(a,"Sitting"); else play(a,"Idle"); });
      sit(a);
    });
    robotsReady = true;
  }
